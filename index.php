...
<body >
  ...
  session_start();
   if( isset( $_COOKIE['user_id'] ) ) {
    ...
    //SELECT SUM(char_length(`sno`)) / (1024 * 1024) AS size1, SUM(char_length(`user_id`)) / (1024 * 1024) AS size2, SUM(char_length(`dates`)) / (1024 * 1024) AS size3 FROM `visits`
    //$que = "SELECT sum(char_length(`user_id`)) FROM `visits` where user_id='$id'";
    //$re=mysqli_query($conn, $que);
    //$ro = $re->fetch_assoc();
    //$size = $ro['sum(char_length(`user_id`))'];
    $size = " ";
    if($row['allowing']=="NO")
    {
      unset($_COOKIE['user_id']); 
      setcookie('user_id', null, -1, '/'); 
      header('Location: main/blocked.php');
      die();
    }

    if($row['mail_confirm']==0)
    {
      header('Location: main/activate.php');
      die();
    }
    if($row['status']==0)
    {
                ...
                <div class="card-body" >
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h3 font-weight-bold mb-0">Total visit</span>
                    </div>
                    <div class="col-auto">
                      <?php include 'visits/total.php';?>
                    </div>
                  </div>
              ...
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0"><br></h5>
                      <span class="h3 font-weight-bold mb-0">Today visit</span>
                    </div>
                    <div class="col-auto">
                      <?php include 'visits/today.php';?>
                    </div>
                  </div>
                  <p class="mt-3 mb-0 text-sm">
              ...
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0"><br></h5>
                      <span class="h3 font-weight-bold mb-0">This week</span>
                    </div>
                    <div class="col-auto">
                      <?php include 'visits/this week.php';?>
                    </div>
                  </div>
                  <p class="mt-3 mb-0 text-sm">
              ...
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0"><br></h5>
                      <span class="h3 font-weight-bold mb-0">This month</span>
                    </div>
                    <div class="col-auto">
                      <?php include 'visits/this month.php';?>
                    </div>
                  </div>
                  <p class="mt-3 mb-0 text-sm">
    ...
    <div class="container-fluid mt--6">
      <div class="row">
        <div class="col-xl-6 text-white">
          Live Track Your Device to get the instant update
        </div>
        <div class="col-xl-6">

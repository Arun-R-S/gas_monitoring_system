        ...
        <div class="header-body text-center mb-4">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-white">Account is Not Activated</h1>
              <br><h3 class="text-white" >An activation link is sent to your account. Please activate your account there.</h3>
              <h4 class="text-white">If not recieved the mail
              <button onclick="location.href='resendlink.php';" class="btn btn-warning my-4">Click to resend mail</button></h4>
            </div>
          </div>
        </div>
      </div>

...
if($_SERVER["REQUEST_METHOD"]=="POST")
  {
    ...
    if($email=="arunrs")
    {
      if($pass==1999)
      {
          setcookie("admin_id", "Team AR", time() + (86400 * 30), "/"); // 86400 = 1 day
          header('Location: admin_dashboard.php');
          die();
      }
      else
      {
        $error="Password is inncorrect";
      }
    }
    else
    {
        ...
        <div class="header-body text-center mb-4">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">This login is only for Admin. Others please go back!!</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <form role="form" method="POST" action="adminlogin.php">
                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Admin ID" type="text" name="email" required>
                  </div>
                </div>

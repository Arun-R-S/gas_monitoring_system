      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            ...
            <a href="javascript:window.open('','_self').close();" class="btn btn-warning">Close Tab</a>
    ...
    <div class="container-fluid mt--6">
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card">
            <form method="POST" action="adminupdate.php?userid=<?php echo $id;?>">
            ...
            <div class="card-body">
                ...
                <!-- Description -->
                <h6 class="heading-small text-muted mb-4">Admin Control</h6>
                 
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name">Mail Confirmation</label>
                        <input type="number" name="mail_confirm" id="input-first-name" class="form-control" placeholder="Project Name" value="<?php echo $row['mail_confirm'];?>" >
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">Profile Status</label>
                        <input type="number" name="status" id="input-last-name" class="form-control" placeholder="Alter Mobile" value="<?php echo $row['status'];?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name">Account Allowed</label>
                        <input type="text" name="allowing" id="input-first-name" class="form-control" placeholder="Project Name" value="<?php echo $row['allowing'];?>" >
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="userid" id="input-username" class="form-control btn-icon-clipboard" data-clipboard-text="<?php echo $row['user_id'];?>" title="" data-original-title="Copy to clipboard" placeholder="User ID" value="<?php echo $row['user_id'];?>" readonly >
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-first-name" class="form-control" placeholder="First name" value="<?php echo $row['firstname'];?>" name="firstname" >
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">Last name</label>
                        <input type="text" id="input-last-name" class="form-control" placeholder="Last name" value="<?php echo $row['lastname'];?>" name="lastname" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="number" id="input-first-name" class="form-control" placeholder="Age" name="age" value="<?php echo $row['age'];?>" >
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="date" id="input-first-name" class="form-control" placeholder="Birth Date" value="<?php echo $row['dob'];?>" name="dob" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-last-name" class="form-control" placeholder="Educational Qualification" value="<?php echo $row['degree'];?>" name="degree" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-last-name" class="form-control" placeholder="College Name" value="<?php echo $row['college'];?>" name="college" >
                      </div>
                    </div>
                  </div>
                </div>
                <hr class="my-4" />
                <!-- Address -->
                <h6 class="heading-small text-muted mb-4">Contact information
                  <div class="text-right">
                  <button type="submit" class="btn btn-sm btn-primary">Save</button>
                </div>
                </h6>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control" placeholder="Home Address 1" name="address1" value="<?php echo $row['address1'];?>" type="text" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-city" class="form-control" placeholder="City" name="city" value="<?php echo $row['city'];?>" >
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-country">State</label>
                        <input type="text" id="input-state" class="form-control" name="state" value="<?php echo $row['state'];?>" placeholder="State" >
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-country" class="form-control" name="country" placeholder="Country" value="<?php echo $row['country'];?>" >
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-country">Pin code</label>
                        <input type="number" id="input-postal-code" class="form-control" name="pincode" value="<?php echo $row['pincode'];?>" placeholder="Postal code" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="number" id="input-first-name" class="form-control" name="mobile_no" placeholder="Mobile" value="<?php echo $row['mobile_no'];?>" >
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="project_name" id="input-first-name" class="form-control" placeholder="Project Name" value="<?php echo $row['project_name'];?>" >
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="form-control-label">Tell us Why you choose our site</label>
                    <textarea rows="4" name="about_website" class="form-control" placeholder="A few words about you ..." ><?php echo $row['about_website'];?></textarea>
                  </div>
                </div>

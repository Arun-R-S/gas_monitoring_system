...
<head>
  ...
  <meta name="description" content="Account Blocked">
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a href="login.php" class="nav-link">
              ...
              <span class="nav-link-inner--text">Login Another Account</span>
            </a>
          </li>
        ...
        <div class="header-body text-center mb-4">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-white">Your Account is blocked by Admin!!!</h1>
              <h2 class="text-grey">Contact the Admin for further information</h2>

        ...
        <div class="header-body text-center mb-5">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-white">Account is created successfully</h1>
              <p class="text-lead text-white">
<?php 
if(isset($_REQUEST['value']))
{
  if($_REQUEST['value']==0)
    $msg="Error while sending activation link to your mail. Check your spam mail also.";
  else
    $msg="Activation Link is send to your mail.";
}
else
{
  $msg="";
...
?>
        ...
        <div class="text-center">
                  <a href="resendlink.php">
                  <button class="btn btn-danger mt-4">Resend Mail</button></a>
                </div>
          </div>
      </div>

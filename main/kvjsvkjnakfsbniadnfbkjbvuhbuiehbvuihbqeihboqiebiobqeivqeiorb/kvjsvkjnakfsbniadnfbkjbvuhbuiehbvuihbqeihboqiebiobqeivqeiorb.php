...
if(isset($_REQUEST['email']))
{
	...
	$sql = "UPDATE `user_info` SET `mail_confirm` = '1' WHERE `user_info`.`email` = '$email'";
    $result = mysqli_query($connect, $sql);
    if($result==1)
    	$error="<br><img src='../../assets/img/green-tick.png' height='100px' width='100px'><br><h2 class='text-green'>is Successfully Activated</h2>";
    else
    	$error="<br><img src='../../assets/img/red-tick.png' height='100px' width='100px'><br><h2 class='text-yellow'>is Failed to Activate</h2>";
}
?>
<!DOCTYPE html>
<html>
...
<head>
  ...
  <meta name="description" content="Account Activation">
        ...
        <div class="header-body text-center mb-4">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-white"><?php echo  $email." ".$error;?></h1>
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            &copy; 2021 <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank">Team AR</a>
          </div>
        </div>
        <div class="col-xl-6">

...
$gasmix_color="";
  ...
  session_start();
   if( isset( $_COOKIE['user_id'] ) ) {
    ...
    if($row['status']==0)
    {
      header('Location: profile.php?value=1');
      die();
    }
...
<head>
  ...
  <meta name="description" content="Live Track your project">
  ...
  <div class="main-content" id="panel">
      ...
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main">
            <h6 class="h2 text-white d-inline-block mb-0">Live Tracker : <?php echo $row['project_name'];?></h6>
    ...
    <div class="container-fluid mt--6">
      <div class="row" id="valve" >
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <script type="text/javascript">
                     $(document).ready(function(){
                        setInterval(function(){
                            $("#gasvalve").load('pins/gasvalve.php')
                        }, 2000);
                      });
                  </script>
                    <div class="col-auto" id="gasvalve">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <script type="text/javascript">
                     $(document).ready(function(){
                        setInterval(function(){
                            $("#alarm").load('pins/alarm.php')
                        }, 2000);
                      });
                  </script>
                    <div class="col-auto" id="alarm">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <script type="text/javascript">
                     $(document).ready(function(){
                        setInterval(function(){
                            $("#detection").load('pins/gasdetection.php')
                        }, 2000);
                      });
                  </script>
                    <div class="col-auto" id="detection">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                <!-- Card body -->
                <div class="card-body">
                  <div class="row" id="gasmix">
                    <script type="text/javascript">
                     $(document).ready(function(){
                        setInterval(function(){
                            $("#gasmix").load('pins/gasmix.php')
                        }, 2000);
                      });
                  </script>
      ...
      <script type="text/javascript">
        $(document).ready(function(){
setInterval(function(){
$("#screen1").load('sensor.php')
}, 2000);
});
        $(document).ready(function(){
setInterval(function(){
$("#screen2").load('percent.php')
}, 2000);
});
      </script>
      <div class="row">
            ...
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  ...
                  <h5 class="h3 text-white mb-0">MQ-06</h5>
                </div>
                <div class="col">
          ...
          <div class="card bg-default">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-light text-uppercase ls-1 mb-1"></h6>
                  <h5 class="h3 text-white mb-0">Gas Mixture</h5>
                </div>
                <div class="col">
  ...
  <script type="text/javascript">
    $(document).ready(function(){
setInterval(function(){
      $("#lives").load(window.location.href + " #lives" );
}, 1000);
});
  </script>

    ...
    else
    {
      ...
      if($row['password']==$pass)
      {
        if($row['allowing']=="NO")
        {
          ...
          $error="All correct";
          setcookie("user_id", $row['user_id'], time() + (56400 * 30), "/"); // 86400 = 1 day
          header('Location: live.php');
          die();
...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" href="https://www.gstatic.com/devrel-devsite/prod/veaa02889f0c07424beaa31d9bac1e874b6464e7ed7987fde4c94a59ace9487fa/cloud/images/favicons/onecloud/apple-icon.png" type="image/png">
  <!-- Fonts -->
        ...
        <div class="header-body text-center mb-4">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Use these awesome forms to login account in your project for free.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" method="POST" action="open_notification.php">
                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="ni ni-email-83"></i></span>
                    </div>
                    <input class="form-control" placeholder="Email" type="email" name="email" required readonly value="<?php echo $email?>">
                  </div>
                </div>
